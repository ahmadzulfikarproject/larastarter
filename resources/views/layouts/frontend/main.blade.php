    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center justify-content-lg-between">
            <h1 class="logo me-auto me-lg-0">
                <a href="{{ route('home') }}">Gp<span>.</span></a>
            </h1>
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    @guest
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('login') }}"><i
                                    class="lni lni-user me-2"></i>{{ __('Login') }}</a>
                        </li>
                    ...
                    @else
                        <li class="dropdown">
                            <a href="#"><i class="lni lni-user"></i><span
                                    class="ms-2">{{ Auth::user()->name }}</span> <i
        ...
        <div class="container" data-aos="fade-up">
            <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
                <div class="col-xl-8 col-lg-8">
                    <h1 class="text-warning">Ready Marathon 2022<span>.</span></h1>
                    <h2>A Marathon Is A State Of Mind That Says Anything Is Possible.</h2>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row text-center">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="heading-count" data-aos="fade-up">
                            <h2 class="wow fadeInDown animated" data-wow-delay="0.2s" style="
                    visibility: visible;
                  ...
                  ">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="row time-countdown justify-content-center wow fadeInUp animated"
                  ...
                  animation-delay: 0.2s;
                ">
                            <div class="simply-countdown simply-countdown-one" data-aos="fade-up"></div>

                        </div>
                        <a href="pricing.html" class="btn btn-primary" data-aos="fade-up">Add to My Calender</a>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3 col-xs-12 work-counter-widget text-center">
                        <div class="counter wow fadeInRight animated" data-wow-delay="0.3s" style="
                  visibility: visible;
                ...
                ">
                    ...
                    <!-- Counter Item -->
                    <div class="col-md-6 col-lg-3 col-xs-12 work-counter-widget text-center">
                        <div class="counter wow fadeInRight animated" data-wow-delay="0.6s" style="
                  visibility: visible;
                ...
                ">
                    ...
                    <!-- Counter Item -->
                    <div class="col-md-6 col-lg-3 col-xs-12 work-counter-widget text-center">
                        <div class="counter wow fadeInRight animated" data-wow-delay="0.9s" style="
                  visibility: visible;
                ...
                ">
                    ...
                    <!-- Counter Item -->
                    <div class="col-md-6 col-lg-3 col-xs-12 work-counter-widget text-center">
                        <div class="counter wow fadeInRight animated" data-wow-delay="1.2s" style="
                  visibility: visible;
